		...
		infiniteCarousel: function(options)
		{
    		...
    		return this.each(function() {
				...
				$('li',obj).each(function(index){ // populate arrays
					...
					itemSources.push( $(this).children('div') ); // finds children divs
				});
				...
				widthSource = o.widthSource != 0 ? o.widthSource : $('li',obj).children('div').width() ;
				heightSource = o.heightSource;
				...
				for(var i=0;i<numItems;i++) $('div.ic_tray',obj).append('<div style="overflow:hidden;background-color: #ddd;float:left;position:relative;width:'+widthSource+'px;height:'+heightSource+'px;" class="infiniteCarousel_item">');
				...
				*/
				$('.infiniteCarousel_item',obj).each(function(index){
					$(this).append(itemSources[index].html());
				});
				...
				$('.ic_left_nav',obj).append('<i class="icon-chevron-left" style="cursor: pointer; font-size: 30px; color: #fff; text-shadow: 0 1px 0 #000;"></i>');
				$('.ic_right_nav',obj).append('<i class="icon-chevron-right" style="cursor: pointer; font-size: 30px; color: #fff; text-shadow: 0 1px 0 #000;"></i>');
				...
				$('.ic_left_nav i',obj).on('click', function(event){
				...
				$('.ic_right_nav i',obj).on('click', function(event){
					if( !$('.ic_tray',obj).is(':animated') )
					{
						stop();
						moveLeft(o.advance);
				...
				if(o.showControls)
				{
					$(obj).append('<div id="ic_controls_'+randID+'" class="ic_controls" style="opacity:.5;cursor:pointer;height:10px;position:absolute;right:9px;top:10px;width:10px;z-index:1">');
