...
@Controller
@RequestMapping("EDIT")
public class SoggettoPortletConfigController {
	
	private static Log logger = LogFactory.getLog(SoggettoPortletConfigController.class);
