		...
		var svg = d3.select("#italybymacroareas").append("svg")
	   	...
	   	function(error, it) {
	    	...
	    	svg.selectAll("g")
		    	...
		    	.attr("class",function(d) { return "link-url-naviga-dettaglio terr-code-" + d.properties.COD_REG + " " + d.properties.COD_REG; })
		    	.attr("d",path)
		    	.attr ("id",function(d) { return d.properties.COD_REG; })
				.on("click", function(d){
				...
				.on("mouseover", function(a){
					...
					svg.selectAll("path").style("fill", function (d){
	    				var retValColor = "#fff";
	    				if (d.properties.COD_REG==a.properties.COD_REG){
	    					if( dimension=='VOLUME'){
	    						retValColor = "#d27900";
	    					}else if(dimension=='COSTO'){
	    						retValColor = "#3e7d46";
	    					...
	    					var legend_circle_class = ".legend-circle-Legend1Territori-cod-" + a.properties.COD_REG;
		    				var circle = d3.select(legend_circle_class);
		    				circle.style("fill", retValColor);
		    				
		    				var legend_class = ".legend-Legend1Territori-cod-" + a.properties.COD_REG;
		    				var legend = d3.select(legend_class);
		    				legend.style("fill", retValColor);
		    				
		    				var histogram_class = ".histogram-Histogram1Territori-cod-" + a.properties.COD_REG;
		    				var histogram = d3.select(histogram_class);
		    				histogram.style("fill", retValColor);
		    				
		    				var histogram_legend_class = ".histogram-legend-Histogram1Territori-cod-" + a.properties.COD_REG;
